...
import {
    Text, View, Image, StyleSheet, TouchableOpacity, ListView
} from 'react-native'
...
class Myantara extends Component {
            ...
            <View style={ styles.header }>
                <View style={ styles.userInfosHolder }>
                    ...
                    <View style={ styles.userInfos }>
                        <Text style={ styles.username }>Didi</Text>
                        <Text style={ styles.description }>Pelajar</Text>
                    </View>
                </View>

                <View style={ styles.tabBar }>
                    <TouchableOpacity style={[ styles.btnTab, {borderRightWidth: 0.5, borderColor: colors.bd_line }]} >
                        <Icon style={ [styles.icoTab, { marginTop: 2 }] } name='power-off' size={ 16 } />
                        <Text style={ styles.btnSearchTitle }>{ 'Logout' }</Text>
                    </TouchableOpacity>

                    <TouchableOpacity style={[ styles.btnTab, {borderRightWidth: 0.5, borderColor: colors.bd_line }]} onPress={this._pressCollection.bind(this)} >
                        <Icon style={ [styles.icoTab, { marginTop: 2 }] } name='bell' size={ 16 } />
                        <Text style={ styles.btnSearchTitle }>{ 'Notifikasi Pembelian' }</Text>
                    </TouchableOpacity>
                </View>
            </View>
        )
